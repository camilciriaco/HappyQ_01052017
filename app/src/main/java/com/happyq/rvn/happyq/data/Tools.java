...
public class Tools {
    ...
    public static void locationAction(final Activity activity) {
    ...
    public static void aboutAction(Activity activity) {
        ...
        builder.setTitle("About HappyQ");
        builder.setMessage("Queueing Application");
        builder.setPositiveButton("OK", null);
        builder.show();
    }

    public static void termsofservicesAction(Activity activity) {
        AlertDialog.Builder builder = new AlertDialog.Builder(activity);
    ...
    public static void sendfeedbackAction(Activity activity) {
        AlertDialog.Builder builder = new AlertDialog.Builder(activity);
