...
public class SharedPref {
    ...
    public static final String GCM_PREF_KEY = "com.happyq.rvn.happyq.GCM_PREF_KEY";
    public static final String SERVER_FLAG_KEY = "com.happyq.rvn.happyq.SERVER_FLAG_KEY";
    public static final String THEME_COLOR_KEY = "com.happyq.rvn.happyq.THEME_COLOR_KEY";

    // need refresh
    public static final String REFRESH_PLACES = "com.happyq.rvn.happyq.REFRESH_PLACES";
