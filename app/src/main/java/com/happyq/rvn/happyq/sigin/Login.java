...
//        }
     ...
     * function to verify login details in mysql db
     * */
//    private void checkFBlogin(final String firstname, final String middlename , final String lastname, final String facebook_id) {
//        // Tag used to cancel the request
//        String tag_string_req = "req_login";
//        mProgressDialog = new ProgressDialog(this);
//        mProgressDialog.setMessage("facebook logging in ....");
//        mProgressDialog.setIndeterminate(true);
//        showDialog();
//
//        StringRequest strReq = new StringRequest(Request.Method.POST, AppConfig.URL_FACEBOOK, new Response.Listener<String>() {
